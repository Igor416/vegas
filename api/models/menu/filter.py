...
class MenuFilter(models.Model):
    ...
    menu_sub_category = models.ForeignKey(
        ...
        verbose_name="Подкатегория в меню",
        related_name="filters",
    )
    products = models.ManyToManyField(
        Product, verbose_name="Товары", related_name="menu_filters", blank=True
    )
    ...
    class Meta:
        ordering = (
            "menu_sub_category__menu_category__order",
            "menu_sub_category__order",
            "order",
        )
