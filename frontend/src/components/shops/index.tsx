...
export function Shops({isMobile}: ResponsiveProps) {
    ...
    <div className='mt-5'>
      <div className='container-fluid d-flex mt-5 px-2 py-1 px-sm-5 py-sm-4'>
        ...
        <div className='col-12 col-sm-10'>
          ...
          {Object.keys(shops).map((name, i) => {
          return (
            <div key={i} className='col-12 col-sm-5 shadow bg-white transition p-3 p-sm-5 my-3 my-sm-5 h6'>
